...
{
	/**
	 * Creates a list of IAction and IContributionItems for the specified modelItem
	 */
	...
	public static <T extends ModelItem> void addActions( 
         T modelItem, List actionsAndContributionItems, SoapUIActionGroup<T> actionGroup )
	{
