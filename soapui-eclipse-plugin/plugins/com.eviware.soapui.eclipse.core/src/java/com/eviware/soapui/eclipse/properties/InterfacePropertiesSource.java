 ...
 * 
 * This class holds eclipse properties for an Interface. It implements IPropertySource
...
public class InterfacePropertiesSource implements IPropertySource {
	...
	public InterfacePropertiesSource(WsdlInterface iFace) {
		this.iFace = iFace;
		PropertyDescriptor defDef = new PropertyDescriptor(DEFINITION_URL_KEY,
		"Definition");
		PropertyDescriptor bindingDef = new PropertyDescriptor(BINDING_KEY,
		"Binding");
		PropertyDescriptor portTypeDef = new PropertyDescriptor(PORTTYPE_KEY,
		"PortType");
		PropertyDescriptor soapVersionDef = new PropertyDescriptor(SOAPVERSION_KEY,
		"SOAP Version");
		PropertyDescriptor cachedDef = new PropertyDescriptor(CACHED_KEY,
		"Cached");
		PropertyDescriptor styleDef = new PropertyDescriptor(STYLE_KEY,
		"Style");
		this.descriptors = new IPropertyDescriptor[]{defDef, bindingDef, portTypeDef, soapVersionDef, cachedDef, styleDef};
	}
