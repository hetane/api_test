 ...
 * @author Lars H
 */
public class SwtAwtRequestEditor extends EditorPart
{
   ...
   @Override
	public void init(IEditorSite site, IEditorInput input)
		...
		if (input instanceof FileEditorInput) {
			Project project = SoapuiAdapterFactory.findSoapuiProject(
					((FileEditorInput) input).getFile());
			if(project == null) throw new PartInitException("Cannot find soapUI project.");
			...
			if (desktopPanel == null) {
				PanelBuilder<ModelItem> panelBuilder = PanelBuilderRegistry
						.getPanelBuilder(modelItem);
		...
		} else throw new PartInitException("Unsupported IEditorInput.");
