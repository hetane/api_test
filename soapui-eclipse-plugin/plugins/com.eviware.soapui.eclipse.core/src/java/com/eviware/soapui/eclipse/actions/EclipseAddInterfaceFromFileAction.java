 ...
 * @author Lars H
 */
public class EclipseAddInterfaceFromFileAction extends AdaptSoapuiObjectAction<Project>
{
   public EclipseAddInterfaceFromFileAction()
   {
      super(Project.class, AddInterfaceActionFromFile.class);
   }
