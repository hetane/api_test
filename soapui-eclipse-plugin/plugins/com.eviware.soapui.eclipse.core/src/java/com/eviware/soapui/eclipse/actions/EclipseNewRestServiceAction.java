 ...
 * @author Dain Nilsson
 */
public class EclipseNewRestServiceAction extends AdaptSoapuiObjectAction<Project>
{
   public EclipseNewRestServiceAction()
   {
      super(Project.class, NewRestServiceAction.class);
   }
