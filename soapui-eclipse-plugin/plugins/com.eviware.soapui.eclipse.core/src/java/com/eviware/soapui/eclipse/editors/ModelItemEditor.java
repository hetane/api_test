...
public class ModelItemEditor extends MultiPageEditorPart
{
	...
	protected void createPages()
   {
		try
      {
        /* ModelItemEditorInput editorInput = (ModelItemEditorInput) getEditorInput();
         setPartName(editorInput.getName());
         
         requestEditor = new MessageEditor();
         int index = addPage(requestEditor, editorInput.getRequestEditorInput());
         setPageText(index, "Request");

         responseEditor = new MessageEditor();
         index = addPage(responseEditor, editorInput.getResponseEditorInput());
    ...
    * This is used when a request has been Recreated.
    */
