...
/**
 * Editor input for a SOAP request and response.
 * TODO Eclipse: Close the editor if the request/operation/interface/project is removed.
 * TODO Eclipse: Change the editor title if the request is renamed.
 * 
 * @author Lars H
 */
