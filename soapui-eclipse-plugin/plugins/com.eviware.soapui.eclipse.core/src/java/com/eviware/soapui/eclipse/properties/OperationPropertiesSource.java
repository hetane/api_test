 ...
 * 
 * This class holds eclipse properties for an Operation. It implements IPropertySource
...
public class OperationPropertiesSource implements IPropertySource {
   ...
   WsdlOperation operation; 
	...
	public OperationPropertiesSource(WsdlOperation operation) {
		...
		PropertyDescriptor soapActionDef = new PropertyDescriptor(SOAPACTION_KEY,
		"SOAPAction");
		PropertyDescriptor operationDef = new PropertyDescriptor(OPERATION_KEY,
		"Operation");
		PropertyDescriptor styleDef = new PropertyDescriptor(STYLE_KEY,
		"Style");
		PropertyDescriptor inputDef = new PropertyDescriptor(INPUT_KEY,
		"Input");
		PropertyDescriptor outputDef = new PropertyDescriptor(OUTPUT_KEY,
		"Output");
		PropertyDescriptor sendsAttachmentsDef = new PropertyDescriptor(SENDS_ATTACHMENTS_KEY,
		"Sends Attachments");
		PropertyDescriptor receivesAttachmentsDef = new PropertyDescriptor(RECEIVES_ATTACHMENTS_KEY,
		"Receives Attachments");
		this.descriptors = new IPropertyDescriptor[]{soapActionDef, operationDef, styleDef, inputDef, outputDef, sendsAttachmentsDef, receivesAttachmentsDef};
	}
