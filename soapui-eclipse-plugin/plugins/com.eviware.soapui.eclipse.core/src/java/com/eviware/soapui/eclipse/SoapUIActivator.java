...
//		soapUICore.prepareUI();
   ...
   static void updateActions()
   {
      ...
      String[] actionsToRemove = {
            NewWorkspaceAction.SOAPUI_ACTION_ID,
            SwitchWorkspaceAction.SOAPUI_ACTION_ID,
      ...
      for(IExtension extension : extensionPoint.getExtensions())
      {
         for(IConfigurationElement configElement : extension.getConfigurationElements())
         {
            ...
            catch(Exception e)
            {
               ...
               // Disable soapUI if Pro *is* installed but no license is present.
               throw e;
            }
         }
      }
				...
				IRunnableWithProgress runnable = new IRunnableWithProgress()
				{
								...
								InterruptedException
					{
                     ...
                     String home = workspaceRoot.getLocation().toOSString();
							...
							monitor.beginTask( "Initializing Web Services Plugin",
...
//		workspace = null;
	...
	/**
	 * Returns the shared instance. Use with caution, it seems this may return null.
	 * 
	...
	private static void initLogging() 
	{
		...
		try
		{
			...
			Appender appender = new FileAppender( new PatternLayout( "%d{ABSOLUTE} %p [%c] %m%n" ),
						logFile, append, bufferedIO, 2000000 );
...
//			PropertyConfigurator.configure( plugin.getClass().getResource( "log4j.properties" ) );
		}
		catch( Throwable t )
		{
			t.printStackTrace();
