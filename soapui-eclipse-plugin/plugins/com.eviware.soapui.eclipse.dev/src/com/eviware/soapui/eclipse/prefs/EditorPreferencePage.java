...
public class EditorPreferencePage extends AbstractPreferencePage<EditorPrefs>
{
	...
	protected void buildForm( FormBuilder editorForm )
	{
		...
		editorForm.appendCheckBox( EditorPrefs.GROOVY_LINE_NUMBERS, "(show line-numbers in groovy editors by default)",
				true );

		editorForm.appendCheckBox( EditorPrefs.NO_RESIZE_REQUEST_EDITOR,
				"(disables automatic resizing of request editors)", true );
		editorForm.appendCheckBox( EditorPrefs.START_WITH_REQUEST_TABS,
				"(defaults the request editor to the tabbed layout)", true );
		editorForm.appendCheckBox( EditorPrefs.AUTO_VALIDATE_REQUEST,
	...
	protected Control createContents( Composite parent )
	{
		...
		values.put( EDITOR_FONT, EditorPrefs.encodeFont( UISupport.getEditorFont() ) );
