...
public class RequestPropertiesSource implements IPropertySource
{
	...
	public RequestPropertiesSource( Request request )
	{
		...
		PropertyDescriptor encoding = new PropertyDescriptor( ENCODING_KEY, "Encoding" );
		PropertyDescriptor endpoint = new PropertyDescriptor( ENDPOINT_KEY, "Endpoint" );
		PropertyDescriptor mtomEnabled = new PropertyDescriptor( MTOMENABLED_KEY, "Enable MTOM/Inline" );
		PropertyDescriptor username = new PropertyDescriptor( USERNAME_KEY, "Username" );
		PropertyDescriptor password = new PropertyDescriptor( PWD_KEY, "Password" );
		PropertyDescriptor domain = new PropertyDescriptor( DOMAIN_KEY, "Domain" );
		PropertyDescriptor wssPasswordType = new PropertyDescriptor( WSSPASSWORDTYPE_KEY, "WSS-Password Type" );
		this.descriptors = new IPropertyDescriptor[] { name, encoding, endpoint, mtomEnabled, username, password, domain,
				wssPasswordType };
