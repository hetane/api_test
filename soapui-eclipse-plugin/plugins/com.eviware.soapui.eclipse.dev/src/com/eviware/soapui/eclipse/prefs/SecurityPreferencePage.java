 ...
 * @author Dain Nilsson
 */
public class SecurityPreferencePage extends AnnotatedPreferencePage
{
	public SecurityPreferencePage()
	{
		super( new AnnotatedSettingsPrefs( SecuritySettings.class, SoapUIPreferencesAction.GLOBAL_SECURITY_SETTINGS ) );
	}
}
