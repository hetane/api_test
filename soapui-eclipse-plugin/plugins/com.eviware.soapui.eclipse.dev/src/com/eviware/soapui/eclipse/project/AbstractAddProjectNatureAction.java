...
public abstract class AbstractAddProjectNatureAction implements IObjectActionDelegate
{
	...
	public void run( IAction action )
	{
		...
		try
		{
			...
			if( UISupport
					.confirm(
							"To explore the SoapUI project, either the Project Explorer view or the SoapUI view need to be used. Switch to the Project Explorer view now?",
							"SoapUI nature added to project" ) )
			{
				final IViewSite site = PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().showView(
						"org.eclipse.ui.navigator.ProjectExplorer" ).getViewSite();
	 ...
	 */
	private Project createSoapUIProject( IProject project, IProgressMonitor monitor ) throws SoapUIException,
	...
	/**
	 * Use the Java project name in the SoapUI project name, to distinguish them
	 * from each other.
	 * 
	 * @param project
	 * @return
	 ...
	 */
	protected abstract StringToStringMap getProjectSettings( IJavaProject javaProject ) throws JavaModelException,
