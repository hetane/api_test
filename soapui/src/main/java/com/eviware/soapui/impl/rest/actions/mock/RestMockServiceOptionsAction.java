...
public class RestMockServiceOptionsAction extends AbstractSoapUIAction<RestMockService> {
    ...
    @AForm(name = "REST MockService Options", description = "Set options for this REST MockService", helpUrl = HelpUrls.REST_MOCKSERVICE_OPTIONS, icon = UISupport.OPTIONS_ICON_PATH)
