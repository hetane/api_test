...
public class MockServiceOptionsAction extends AbstractSoapUIAction<WsdlMockService> {
    ...
    @AForm(name = "SOAP MockService Options", description = "Set options for this SOAP MockService", helpUrl = HelpUrls.MOCKSERVICEOPTIONS_HELP_URL, icon = UISupport.OPTIONS_ICON_PATH)
